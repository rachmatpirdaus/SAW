...
while ($data = mysqli_fetch_array ($hasil)){  
 			...
 			echo "      
                    ...
                    <td>".$data[3]."</td>
                    <td>".$data[4]."</td>
                    <td><a href=\"edatasiswa.php?id=".$data[0]."\"><i class='glyphicon glyphicon-pencil'></i></a> "." &nbsp; &nbsp;<a href=\"delete.php?id=".$data[0]."\" onclick='return checkDelete()'><i class='glyphicon glyphicon-trash'></i></a> </td>
                    </tr>   
        	";      
			}
 ?> 
